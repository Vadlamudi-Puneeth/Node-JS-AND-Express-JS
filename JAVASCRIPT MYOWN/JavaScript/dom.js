...
//     <button onClick = "alertText(event)" >done</button>
//     `
// }
...
const dummyparentclick = (e) =>{
  console.log("parent clicked",e);
}

const dummychildclick = (e) =>{
  console.log("child clicked",e);
}

const entirebodyclick = (e) => {
  console.log("entire");
}

let entirebtn = document.querySelector(".entire-body");

entirebtn.addEventListener("click", entirebodyclick)
